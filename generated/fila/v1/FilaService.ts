...
import type { StreamEnqueueRequest as _fila_v1_StreamEnqueueRequest, StreamEnqueueRequest__Output as _fila_v1_StreamEnqueueRequest__Output } from '../../fila/v1/StreamEnqueueRequest';
import type { StreamEnqueueResponse as _fila_v1_StreamEnqueueResponse, StreamEnqueueResponse__Output as _fila_v1_StreamEnqueueResponse__Output } from '../../fila/v1/StreamEnqueueResponse';
...
export interface FilaServiceClient extends grpc.Client {
  ...
  StreamEnqueue(metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientDuplexStream<_fila_v1_StreamEnqueueRequest, _fila_v1_StreamEnqueueResponse__Output>;
  StreamEnqueue(options?: grpc.CallOptions): grpc.ClientDuplexStream<_fila_v1_StreamEnqueueRequest, _fila_v1_StreamEnqueueResponse__Output>;
  streamEnqueue(metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientDuplexStream<_fila_v1_StreamEnqueueRequest, _fila_v1_StreamEnqueueResponse__Output>;
  streamEnqueue(options?: grpc.CallOptions): grpc.ClientDuplexStream<_fila_v1_StreamEnqueueRequest, _fila_v1_StreamEnqueueResponse__Output>;
...
export interface FilaServiceHandlers extends grpc.UntypedServiceImplementation {
  ...
  StreamEnqueue: grpc.handleBidiStreamingCall<_fila_v1_StreamEnqueueRequest__Output, _fila_v1_StreamEnqueueResponse>;
...
export interface FilaServiceDefinition extends grpc.ServiceDefinition {
  ...
  StreamEnqueue: MethodDefinition<_fila_v1_StreamEnqueueRequest, _fila_v1_StreamEnqueueResponse, _fila_v1_StreamEnqueueRequest__Output, _fila_v1_StreamEnqueueResponse__Output>
}
